<header>
    ...
    <div class="container">
        ...
        <figure class="figure mb-0">
            ...
            <figcaption>
                <?php if(isset($powered) && $powered=="AMBT"){ echo "Powered by American Broadband + Telecommunication"; }else if(isset($powered) && $powered=="NAL"){echo "Powered by National Relief Telecom";} ?></figcaption>
        </figure>
        ...
        <div id="navcol-1" class="collapse navbar-collapse">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item" style="text-align: right;">
                    <a class="nav-link active pb-0" target="_blank" href="mailto:check@galaxydistribution.com">check@galaxydistribution.com <i class="fa fa-envelope"></i></a>
            ...
            <?php if(isset($apply) && $apply){ ?><button class="btn btn-primary fs-5 py-2 px-4" data-bs-toggle="modal" data-bs-target="#exampleModal">Apply Now</button> <?php } ?>
        </div>
    </div>
</nav>
</header>
