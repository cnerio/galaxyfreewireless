...
<h3 class="text-lg font-bold text-brand-navy">What is Lifeline?</h3>
<p class="mt-2 text-sm leading-6 text-slate-500">Since 1985, the federal Lifeline benefit has provided subsidized phone service to qualifying low-income households. Our network of Lifeline providers is proud to offer zero-cost phone service through Lifeline.</p>
</article>
...
<h3 class="text-lg font-bold text-brand-navy">$0 Cost</h3>
<p class="mt-2 text-sm leading-6 text-slate-500">Eligible Costumers receive wireless service for free.</p>
</article>
